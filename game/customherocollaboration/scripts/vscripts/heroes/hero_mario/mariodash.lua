function dash(keys)
	...
	local dashingmodifier = keys.dashmodifier

	--talent
	local talent = caster:FindAbilityByName("dash_bonus")
	...
	ability:ApplyDataDrivenModifier(caster, caster, dashingmodifier, {})
	...
	Timers:CreateTimer(0, function()
		...
		if traveled_distance < distance then
			...
			caster:RemoveModifierByName(dashingmodifier)
		end
	end)
end
